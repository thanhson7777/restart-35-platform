...
VIETNAMESE_SKILL_PHRASES = [
    ...
    "marketing", "kinh doanh", "bán hàng", "chăm sóc khách hàng",
    "kỹ năng giao tiếp", "kỹ năng lãnh đạo", "kỹ năng thuyết trình",
    "tiếng anh", "tiếng trung", "tiếng nhật", "tiếng hàn",
    "nhân viên", "trưởng phòng", "giám đốc", "quản lý",
    "hành chính", "nhân sự", "tuyển dụng", "đào tạo",
    "kế toán", "tài chính", "ngân hàng", "bảo hiểm",
    "xây dựng", "kiến trúc", "kỹ thuật", "cơ khí", "điện",
    "bảo vệ", "an ninh", "giao hàng", "vận chuyển", "lái xe",
    "phục vụ", "nhà hàng", "khách sạn", "du lịch",
    "giáo viên", "giảng viên", "giáo dục", "đào tạo",
    "y tế", "bác sĩ", "dược", "điều dưỡng",
