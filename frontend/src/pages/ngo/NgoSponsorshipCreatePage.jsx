    ...
    <NgoLayout>
      <div className="max-w-2xl space-y-6">
        ...
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Thiết lập chương trình tài trợ học bổng cho người lao động.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="bg-[#111827] border border-slate-800 rounded-2xl p-6 space-y-5">
            <div>
              ...
              <Input value={form.title} onChange={set('title')} placeholder="VD: Học bổng NGO Việc làm 2026" className="bg-slate-900 border-slate-700 text-white" />
            </div>
            <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input type="number" min={1} value={form.budget} onChange={set('budget')} placeholder="VD: 100000000" className="bg-slate-900 border-slate-700 text-white" />
              </div>
              <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select value={form.coverageType} onChange={set('coverageType')} className="w-full rounded-xl border border-slate-700 bg-slate-900 text-white p-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
              ...
              <div>
                ...
                <select value={form.disbursementModel} onChange={set('disbursementModel')} className="w-full rounded-xl border border-slate-700 bg-slate-900 text-white p-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
          ...
          <div className="flex gap-3">
            ...
            <Button type="button" variant="outline" onClick={() => navigate('/ngo/sponsorships')} className="border-slate-800 text-slate-300">
              Hủy
            </Button>
          </div>
        </form>
