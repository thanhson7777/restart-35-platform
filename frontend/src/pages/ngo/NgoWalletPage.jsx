...
export default function NgoWalletPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      <div>
        <h1 className="text-3xl font-extrabold text-[hsl(var(--admin-text-primary))]">Ví Tài Trợ (Wallet)</h1>
        <p className="text-[hsl(var(--admin-text-muted))] text-sm mt-1">
          Quản lý nguồn vốn, nạp tiền và theo dõi dòng tiền giải ngân cho người lao động.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-blue-300 text-xs font-medium uppercase flex items-center gap-1 mb-1">
                    <Lock size={12} /> Tiền đang phong tỏa (Đã lập quỹ)
                  </p>
                  <p className="text-xl font-semibold text-amber-200">{formatCurrency(wallet.lockedBalance)}</p>
                </div>
                <div>
                  <p className="text-blue-300 text-xs font-medium uppercase mb-1">Tổng tiền đã giải ngân</p>
        ...
        <div className="bg-[hsl(var(--admin-surface))] border border-[hsl(var(--admin-border))] rounded-2xl p-6 flex flex-col justify-center">
          <h3 className="font-bold text-[hsl(var(--admin-text-primary))] text-lg mb-4">Làm thế nào để tài trợ?</h3>
          <ul className="space-y-4">
            <li className="flex gap-3 text-sm">
              ...
              <p className="text-[hsl(var(--admin-text-secondary))]"><strong className="text-[hsl(var(--admin-text-primary))]">Nạp tiền vào ví:</strong> Sử dụng VNPay để nạp quỹ vào Số dư khả dụng.</p>
            </li>
            <li className="flex gap-3 text-sm">
              ...
              <p className="text-[hsl(var(--admin-text-secondary))]"><strong className="text-[hsl(var(--admin-text-primary))]">Tạo Quỹ tài trợ:</strong> Khi bạn tạo quỹ, tiền sẽ chuyển sang trạng thái "Phong tỏa" để chờ học viên.</p>
            </li>
            <li className="flex gap-3 text-sm">
              ...
              <p className="text-[hsl(var(--admin-text-secondary))]"><strong className="text-[hsl(var(--admin-text-primary))]">Giải ngân tự động:</strong> Ngay khi bạn duyệt đơn xin tài trợ, tiền sẽ được chuyển trực tiếp cho Giảng viên.</p>
            </li>
          </ul>
        </div>
      </div>
