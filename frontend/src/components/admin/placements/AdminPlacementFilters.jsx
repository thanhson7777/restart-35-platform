...
const TABS = [
  ...
  { key: 'promoted', label: 'Được thăng' },
];

const AdminPlacementFilters = ({ filters, onChange, onSearch }) => {
    ...
    <div className="bg-[hsl(var(--admin-surface))] border border-[hsl(var(--admin-border))] rounded-2xl p-4 mb-6">
      <div className="flex gap-3 mb-4">
        <div className="flex-1 relative">
          ...
          <input
            type="text" placeholder="Tìm kiếm worker, công ty..." value={searchValue}
...
export default AdminPlacementFilters;
